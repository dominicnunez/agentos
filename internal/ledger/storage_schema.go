...
FROM events WHERE event_type IN ('COMPLETION_REVIEW_REQUESTED','COMPLETION_REVIEW_DECIDED','TASK_EXECUTION_SUSPENDED','TASK_VERIFIED_COMPLETE','COMPLETION_REJECTED','TASK_DEPENDENCY_FAILED','TASK_REMEDIATION_FAILED','TASK_WORK_FAILED') ORDER BY sequence`))
	if err != nil {
