...
| Repository change control | CI and release-artifact workflows run on pushes and pull requests, and reviewed changes have retained Git history | PARTIAL | Approve and enforce a `main` branch protection or repository ruleset, required checks, review policy, and audited break-glass procedure under [Issue #127](https://github.com/dominicnunez/agentos/issues/127) |
