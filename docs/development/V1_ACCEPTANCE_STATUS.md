...
- Projection-admission tests bind each materialized organizational record to
  ...
  copied seals, malformed or duplicate JSON, corrupt linkage, permissive
  pre-release migration, event-only replay forgery, and backup/restore drift.
