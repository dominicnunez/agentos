...
| AI system inventory | Authenticated bounded JSON export of durable Agents, roles, lifecycle and configuration state, providers, models, runtime adapters, aggregate operations, typed projection sources, explicit gaps, and export fingerprint | PARTIAL | Operator-owned intended-purpose, accountable-owner, intended-user, data, dependency-risk, deployment, retention, and review records |
