...
func TestAllowedDashboardRoute(t *testing.T) {
	tests := []struct {
		...
		{http.MethodGet, "/v1/user/incidents/replay", "conversation_id=work-1", true},
		{http.MethodGet, "/v1/user/incidents/replay", "conversation_id=work-case%40partner", true},
		{http.MethodGet, "/v1/user/incidents/replay", "conversation_id=case%2F2026", true},
		...
		{http.MethodGet, "/v1/user/incidents/replay", "", false},
		{http.MethodGet, "/v1/user/incidents/replay", "conversation_id=work-1&scope=all", false},
		{http.MethodGet, "/v1/user/incidents/replay", "conversation_id=one&conversation_id=two", false},
		{http.MethodPost, "/v1/user/incidents/replay", "conversation_id=work-1", false},
