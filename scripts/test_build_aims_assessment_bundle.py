...
class BuildAIMSAssessmentBundleTest(unittest.TestCase):
    def setUp(self) -> None:
        ...
        for relative in (
            "README.md",
            "SECURITY.md",
            "docs/governance/ai-management-system.md",
            "docs/guides/approval-control.md",
            "docs/security/event-ledger-integrity.md",
            "docs/operations/governance-inspection.md",
            "docs/operations/incident-replay.md",
            "docs/architecture/lab.md",
            "docs/architecture/organizational-knowledge.md",
            "docs/architecture/shared-coordination.md",
            "docs/operations/sqlite-recovery.md",
            "docs/threat-model.md",
            "docs/development/build-contract.md",
            "docs/development/v1-acceptance-status.md",
