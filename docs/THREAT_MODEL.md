...
| Controlled replanning | in-place Plan mutation, reopened Tasks, replacement forks or cycles, cross-tenant lineage, authority or evidence inheritance | one explicit reviewed predecessor; prior failed state; same organization and Goal; one direct successor; fresh Intent, Work, Plan, and Task DAG; atomic admission and replay validation; no inherited approval, capability, effect permission, artifacts, completion, or execution state; Lab replacement rejected | replacement lineage records deliberate recovery but cannot guarantee that the new plan is effective |
