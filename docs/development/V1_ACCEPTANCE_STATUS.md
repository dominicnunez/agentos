...
| 13 | Restart continuity | PASS - [`TestRecoverExecutesPersistedPendingWorkAndPreservesIdentity`](../../internal/app/service_test.go), [`TestRecoverResumesOnlyRevalidatedAssignmentBlock`](../../internal/app/service_test.go), [`TestCompletedWorkDrivesEvidenceBackedGoalProgress`](../../internal/app/service_test.go), [`TestRecoveryRejectsCausallyReorderedGoalEvidence`](../../internal/ledger/goal_recovery_integration_test.go), [`TestRecoveryRejectsSupersededAgentDispatchBinding`](../../internal/ledger/recovery/sqlite_test.go), [`TestOpenMigratesStorageV1FixtureWithoutRewritingLedger`](../../internal/ledger/storage_schema_test.go), [`TestStorageV1FixtureMigratesAndRebuildsFromEvents`](../../internal/projections/storage_migration_integration_test.go), [`TestOldestSupportedStorageFixtureVerifiesBacksUpRestoresAndMigrates`](../../internal/ledger/recovery/sqlite_test.go), [`TestProtectedEffectWaitsAcrossRestartForExactAuthorizedDecision`](../../internal/approvals/service_test.go), [`TestMessageInboxSurvivesReopenAndObservation`](../../internal/ledger/sqlite_test.go) |
