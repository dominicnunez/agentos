...
func TestReadyConfigurationRequiresRealTypedProvider(t *testing.T) {
	...
	config.Providers = []Provider{{Kind: "fake", Model: "fake"}}
	...
	config.Providers = []Provider{{Kind: ProviderOpenAIAPI, Model: "gpt-5.4-2026-06-01", SecretRef: "openai-api-key"}}
...
func TestSystemOwnerMayBeVerifiedRootAccount(t *testing.T) {
	...
	config.Providers = []Provider{{Kind: ProviderOpenAIAPI, Model: "gpt-test-2026-01-01", SecretRef: "openai-api-key"}}
	if err := config.ValidateReady(); err != nil {
